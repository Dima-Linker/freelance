...
export type StorageHash =
  StorageHashBase<'d7e13dc80336a28b8b94d41d413096b16da849af979b2d98aa9eb6cec427db1c'>;
export type ExecutionHash =
  ExecutionHashBase<'bf59fc9a65d148472884311d48367d2608b9efb618b82899ced1334062fda9af'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Job: {
      ...
      readonly remote: CodecTypes['pg/bool@1']['output'];
      readonly workYears: CodecTypes['pg/int4@1']['output'];
      readonly budgetMin: CodecTypes['pg/int4@1']['output'];
      readonly budgetMax: CodecTypes['pg/int4@1']['output'];
      readonly clientId: CodecTypes['pg/uuid@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly JobTechnology: {
      readonly jobId: CodecTypes['pg/uuid@1']['output'];
      readonly technologyId: CodecTypes['pg/uuid@1']['output'];
    };
    readonly Post: {
...
export type FieldInputTypes = {
  readonly public: {
    readonly Job: {
      ...
      readonly remote: CodecTypes['pg/bool@1']['input'];
      readonly workYears: CodecTypes['pg/int4@1']['input'];
      readonly budgetMin: CodecTypes['pg/int4@1']['input'];
      readonly budgetMax: CodecTypes['pg/int4@1']['input'];
    ...
    readonly JobTechnology: {
      ...
      readonly technologyId: CodecTypes['pg/uuid@1']['input'];
    };
    readonly Post: {
        ...
        readonly entries: {
          readonly table: {
            readonly job: {
              ...
              indexes: readonly [
                {
                  readonly name: 'job_clientId_idx_153a9a49';
                  readonly prefix: 'job_clientId_idx';
            ...
            readonly jobTechnology: {
              ...
              indexes: readonly [
                {
                  readonly name: 'jobTechnology_jobId_idx_623c8f77';
                  readonly prefix: 'jobTechnology_jobId_idx';
                  readonly columns: readonly ['jobId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'jobTechnology_technologyId_idx_1e2af707';
                  readonly prefix: 'jobTechnology_technologyId_idx';
                  readonly columns: readonly ['technologyId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'jobTechnology';
                    readonly columns: readonly ['jobId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
...
> & {
  ...
  readonly roots: {
    ...
    readonly technology: {
      ...
      readonly model: 'Technology';
    };
    readonly jobTechnology: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'JobTechnology';
    };
  };
  readonly domain: {
    readonly namespaces: {
          ...
          readonly Job: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly remote: { readonly column: 'remote' };
                readonly workYears: { readonly column: 'workYears' };
          ...
          readonly JobTechnology: {
            ...
            readonly relations: {
              ...
              readonly technology: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['technologyId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              readonly table: 'jobTechnology';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly jobId: { readonly column: 'jobId' };
                readonly technologyId: { readonly column: 'technologyId' };
              };
            };
          };
          readonly Post: {
          ...
          readonly Technology: {
            ...
            readonly relations: {
              readonly jobs: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['technologyId'];
                };
              };
            };
            readonly storage: {
              readonly table: 'technology';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly title: { readonly column: 'title' };
